...
### Instruções
1. Faça um **Fork** (Botão fork na página do projeto original.
    Selecionando a conta para fazer o fork.
    Copiando a URL para fazer o clone da minha cópia do projeto.
    Clone do projeto, repare no subdiretório criado.
    Meus servidores remotos.
    Repositórios remotos origin e upstream.) deste repositório;
